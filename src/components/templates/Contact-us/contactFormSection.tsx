...
const ContactFormSection = () => {
  ...
  const addCustomary = async (event:any) => {
    ...
    if(res.status === 201){
      ...
      setEmail("")
      setPost("")
      ToastSuccess("اطلاعات شما با موفقیت صبت شد" , "success")
    }
  ...
  return (
    <section className={ `relative bg-white py-10 flex justify-center items-center ${Styles.section_forms}`}>
      <ToastComponent />
        ...
        <div className="w-full h-[100%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-items-center content-center">
          <div className="contact-us-bio w-full  flex flex-col p-4 justify-center items-center gap-10">
            <div className="contact-us-bio_header w-full">
              <p className="text-4xl font-black text-[#212121] mb-4">دفتر مرکزی</p>
              <div className="w-[90%] mt-10">
                <span className="text-[#212121]">
                  در واقع من به یک ولپوت نیاز دارم که بخواهد باردار شود. در فصل
                  بسکتبال اما همچنین یک عنصر مخمر خالص است. اما همیشه غم انگیز
                  است و زنان باردار هدف قرار می گیرند. هیچ چیز آسانی وجود ندارد.
                </span>
              </div>
            </div>
              ...
              <div className="flex justify-start items-center gap-10">
                <ul>
                  ...
                  <li className="flex justify-start items-center gap-4">
                    ...
                    <p className="font-md text-md text-[#aaa]"> نشانی ادربیل خیابان عطایی</p>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`opening-hours w-full ${Styles.open_bg} p-8`}>
            <div className="border border-8 border-white h-full h-full p-7">
              <div className="introduce_des_time text-center  text-white">
                <h3 className="mb-5 text-lg md:text-xl mb-4">ساعات کاری کافه</h3>
          ...
          <div className="form-box h-full w-full bg-[#F6F6F6] p-4">
            <form className="flex flex-col text-[#212121] justify-center items-center h-full gap-3">
              ...
              <div className="submit-button my-5">
                <button type="submit" className={Styles.introduce_des_bio_button} onClick={addCustomary}>ارسال</button>
              </div>
            </form>
          </div>
        </div>
